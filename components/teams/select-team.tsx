          ...
          <DropdownMenuContent className="w-[250px] px-0 pb-1.5 pt-2 sm:w-[270px] lg:w-[240px] xl:w-[270px]">
            {teams.map((team) => (
              <div
                ...
                className={cn(
                  `flex w-full cursor-pointer items-center justify-between truncate px-2 py-2 text-sm font-normal transition-all duration-75 hover:bg-gray-200 hover:dark:bg-gray-800`,
