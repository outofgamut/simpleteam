...
import { DocumentWithLinksAndLinkCountAndViewCount, OrganizationMembership, OrganizationUser } from "@/lib/types";
...
export default function MembershipCard({
  ...
  const handleDuplicateDocument = async (event: any) => {
    ...
    toast.promise(
      fetch(
        `/api/teams/${teamInfo?.currentTeam?.id}/documents/${membership.userId}/duplicate`,
        { method: "POST" },
      ).then(() => {
