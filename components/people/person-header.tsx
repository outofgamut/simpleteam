...
import { Document, DocumentVersion, Skill } from "@prisma/client";
import { MailIcon, Phone, PhoneIcon, PocketKnifeIcon, Sparkles, TrashIcon } from "lucide-react";
...
export default function PersonHeader({
  ...
  const mockHeaderData = {
    name: "Brian Orrell",
    imageUrl: "https://pbs.twimg.com/profile_images/655136278514528256/_UDzfU3V_400x400.jpg",
    ...
    if (document.assistantEnabled) {
      ...
      toast.promise(
        ...
        }),
        {
          ...
          success: "Simpleteam Assistant successfully activated.",
  ...
  const activateOrDeactivateAssistant = async (
    ...
    toast.promise(fetchPromise, {
      ...
      success: `Simpleteam Assistant successfully ${active ? "activated" : "deactivated"}.`,
        ...
        <div className="mt-1 flex flex-col lg:mt-0 space-y-2">
          ...
          <div className="text-sm grid grid-cols-2 gap-6">
            <div className="flex-col space-y-1">
              <div>
                {mockHeaderData.title}
              </div>
              <div>
                {mockHeaderData.location}
              </div>
              <div>
            ...
            <div className="flex-col space-y-1">
              <div>
                Employee since {mockHeaderData.hired}
              </div>
              <div>
                {mockHeaderData.school}
              </div>
              <div>
                {mockHeaderData.major}
              </div>
            </div>
